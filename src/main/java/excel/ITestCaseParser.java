...
public interface ITestCaseParser {
	...
	String getCellValue(String sheetName, String testCaseName, String testDataKey) throws IOException;
	int getCellValueAsInt(String sheetName, String testCaseName, String testDataKey) throws IOException;
