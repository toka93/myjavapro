...
public class ExcelTestParser implements ITestCaseParser {
	 ...
	 */
	@Override
	public String getCellValue(String sheetName, String testCaseName, String columnName) throws IOException {
	...
	public int getCellValueAsInt(String sheetName, String testCaseName, String columnName) throws IOException {
		int columnIndex = excelParser.getColumnIndex(sheetName, columnName);
		System.out.println(columnIndex);
