...
public class Tests extends BaseConfiguration {
	Logger log = LogManager.getLogger(Tests.class);
	...
	@Test
	public void Testweb(Method method) throws AWTException, InterruptedException, IOException {
		...
		signPage.enterEmail(driver, mobile);
